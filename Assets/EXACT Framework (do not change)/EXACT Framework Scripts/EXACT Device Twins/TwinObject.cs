...
namespace ExactFramework
{
    ...
    public abstract class TwinObject : MonoBehaviour
    {
        ...
        ///<summary>
        ///Bool set if the config name variable should be used to connect. Set in the inspector or code.true
        ///</summary>
        public bool useConfigName = true;
        ...
        public string configNameDoNotChange;
   ...
   //     public bool UseDeviceName1 { get => useDeviceName; set => useDeviceName = value; }
        ...
        protected virtual void TwinStart()
        {
        }
        ...
        public void SendActionMessage(string componentName, string payload)
        {
            ...
            //DS   temp.Add((byte)payload.Length);
       ...
       //     SendDeviceMessage(deviceID + "/ping", true);
        ...
        public virtual void DeviceJustDisconnected()
        {
        ...
        ///</summary>
        ///<param name="_linked">Bool to set for the linked status.</param>
        public void SetLinkStatus(bool _linked)
        {
            if (!_linked)  // Disconnected
            {
                DeviceJustDisconnected();
            };
            this.linked = _linked;
        }
        ...
        public T AddDeviceComponent<T>(string id) where T : DeviceComponent
        {
            ...
            component.Start(); // DS... Needs an extra kick to get it operative from frame 0;
            return component;
        }
        ...
        public List<TwinObject> GetTwinObjectList()  // DS
        {
            if (mqttHandler != null)
            {
